...
sudo mv -f Module1.xba /root/.config/libreoffice/3/user/basic/Standard
sudo mv -f registrymodifications.xcu /root/.config/libreoffice/3/user
sudo mv -f .xscreensaver /root
